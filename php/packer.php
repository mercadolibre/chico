 ...
 */   
    ...
    // files to load
    private $files;    
    private $components = "carousel,dropdown,layer,modal,tabNavigator,tooltip,validator,string,number,required,helper";
    private $internals = "position,positioner,object,floats,navs,watcher";
