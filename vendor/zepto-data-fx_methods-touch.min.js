...
/* Zepto v1.0-1-ga3cab6c - data - zeptojs.com/license - http://jscompress.com/ */
;(function(e){function s(s,u){var a=s[i],f=a&&t[a];if(u===undefined)return f||o(s);else{if(f){if(u in f)return f[u];var l=r(u);if(l in f)return f[l]}return n.call(e(s),u)}}function o(n,s,o){var a=n[i]||(n[i]=++e.uuid),f=t[a]||(t[a]=u(n));if(s!==undefined)f[r(s)]=o;return f}function u(t){var n={};e.each(t.attributes,function(t,i){if(i.name.indexOf("data-")==0)n[r(i.name.replace("data-",""))]=e.zepto.deserializeValue(i.value)});return n}var t={},n=e.fn.data,r=e.camelCase,i=e.expando="Zepto"+ +(new Date);e.fn.data=function(t,n){return n===undefined?e.isPlainObject(t)?this.each(function(n,r){e.each(t,function(e,t){o(r,e,t)})}):this.length==0?undefined:s(this[0],t):this.each(function(){o(this,t,n)})};e.fn.removeData=function(n){if(typeof n=="string")n=n.split(/\s+/);return this.each(function(){var s=this[i],o=s&&t[s];if(o)e.each(n,function(){delete o[r(this)]})})}})(Zepto)
/* Zepto v1.0-1-ga3cab6c - fx_methods - zeptojs.com/license - http://jscompress.com/ */
;(function(e,t){function u(n,r,i,s,o){if(typeof r=="function"&&!o)o=r,r=t;var u={opacity:i};if(s){u.scale=s;n.css(e.fx.cssPrefix+"transform-origin","0 0")}return n.animate(u,r,null,o)}function a(t,n,r,i){return u(t,n,0,r,function(){s.call(e(this));i&&i.call(this)})}var n=window.document,r=n.documentElement,i=e.fn.show,s=e.fn.hide,o=e.fn.toggle;e.fn.show=function(e,n){i.call(this);if(e===t)e=0;else this.css("opacity",0);return u(this,e,1,"1,1",n)};e.fn.hide=function(e,n){if(e===t)return s.call(this);else return a(this,e,"0,0",n)};e.fn.toggle=function(n,r){if(n===t||typeof n=="boolean")return o.call(this,n);else return this.each(function(){var t=e(this);t[t.css("display")=="none"?"show":"hide"](n,r)})};e.fn.fadeTo=function(e,t,n){return u(this,e,t,null,n)};e.fn.fadeIn=function(e,t){var n=this.css("opacity");if(n>0)this.css("opacity",0);else n=1;return i.call(this).fadeTo(e,n,t)};e.fn.fadeOut=function(e,t){return a(this,e,null,t)};e.fn.fadeToggle=function(t,n){return this.each(function(){var r=e(this);r[r.css("opacity")==0||r.css("display")=="none"?"fadeIn":"fadeOut"](t,n)})}})(Zepto)
/* Zepto v1.0-1-ga3cab6c - touch - zeptojs.com/license - http://jscompress.com/ */
