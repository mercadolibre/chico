(function (window, $, ch) {
    ...
    Tooltip.prototype.init = function ($el, options) {
         ...
         * @type string
         */
        this._attrReference = (this.el.title !== '') ? 'title' : 'alt';
         ...
         * @type string
         */
        this._attrContent = this.el.title || this.el.alt;
        ...
        this.$el
            ...
            .on(this._options.event + '.tooltip', function (event) {
         ...
         */
        this.$container = $('<div>')
            .addClass('ch-' + this.name + ' ch-cone ch-hide ' + this._options.classes)
            .attr({
                'role': 'tooltip',
                'id': id
            })
         ...
         * @see ch.Content
         */
        this._$content = $('<div class="ch-tooltip-content">').appendTo(this.$container);

        this.position = new ch.Positioner({
            'target': this.$container,
            'reference': this.$el,
            'side': this._options.side,
            'aligned': this._options.aligned,
            'offsetY': this._options.offsetY,
            'offsetX': this._options.offsetX
        });
    };

    Tooltip.prototype._active = false;
    ...
    Tooltip.prototype.hide = function () {
        //
        this.el[this._attrReference] = this._attrContent;
        //
